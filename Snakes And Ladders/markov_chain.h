...
/***************************/
//pointers to functions of generic usage.
...
typedef struct MarkovNode{
 ...
 int frequency_list_length; //counter to length of frequency list.
} MarkovNode;
...
/**
 * Choose randomly the next state, depend on its occurrence frequency.
